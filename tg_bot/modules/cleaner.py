...
__help__ = """
 ...
 Following commands are only Nations members use, admins cannot use these:
  - /gignoreblue <word> - globally ignore bluetext cleaning of saved word across Megatron.
